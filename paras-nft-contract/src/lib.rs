...
const DATA_IMAGE_ICON: &str = "data:image/svg+xml,%3Csvg width='1080' height='1080' viewBox='0 0 1080 1080' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='1080' height='1080' rx='10' fill='%230000BA'/%3E%3Cpath stroke='%23000' stroke-width='140' stroke-dasharray='6,27.5' d='M90,20V160M20,90H160' fill='white'/%3E%3C/svg%3E";
    ...
    pub fn new_default_meta(owner_id: ValidAccountId, treasury_id: ValidAccountId) -> Self {
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Land_Title".to_string(),
                symbol: "LAND_TITLE".to_string(),
                icon: Some(DATA_IMAGE_ICON.to_string()),
                base_uri: Some("https://TheKinDAO.com".to_string()),
                reference: None,
                reference_hash: None,
            },
            500,
